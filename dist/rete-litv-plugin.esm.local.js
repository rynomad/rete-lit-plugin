...
function _toPropertyKey$f(arg) { var key = _toPrimitive$f(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive$f(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var Connection = _decorate$f([customElement('connection-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "styles",
      value: function value() {
        return css(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["\n    svg {\n      overflow: visible !important;\n      position: absolute;\n      pointer-events: none;\n      width: 9999px;\n      height: 9999px;\n    }\n    path {\n      fill: none;\n      stroke-width: 5px;\n      stroke: steelblue;\n      pointer-events: auto;\n    }\n  "])));
      }
    }, {
      kind: "method",
      key: "render",
...
function _toPropertyKey$e(arg) { var key = _toPrimitive$e(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive$e(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ConnectionWrapper = _decorate$e([customElement('connection-wrapper')], function (_initialize, _LitElement) {
    ...
    d: [{
      ...
      value: function render() {
        if (this.component) {
          ...
          return html(_templateObject$g || (_templateObject$g = _taggedTemplateLiteral(["", ""])), dynamicComponent);
        }
...
var Control = _decorate$d(null, function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "styles",
      value: function value() {
        return [vars$1, css(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n    input {\n      width: 100%;\n      border-radius: 30px;\n      background-color: white;\n      padding: 2px 6px;\n      border: 1px solid #999;\n      font-size: 110%;\n      box-sizing: border-box;\n    }\n  "])))];
      }
    }, {
      kind: "method",
      key: "render",
...
var Node = _decorate$c([customElement('node-component')], function (_initialize, _LitElement) {
      ...
      value: function render() {
        ...
        return html(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["\n            <div\n                class=\"node ", "\"\n                style=", "\n                data-testid=\"node\"\n            >\n                <div class=\"title\" data-testid=\"title\">", "</div>\n\n                <!-- Outputs -->\n                ", "\n\n                <!-- Controls -->\n                ", "\n\n                <!-- Inputs -->\n                ", "\n            </div>\n        "])), (_this$data6 = this.data) !== null && _this$data6 !== void 0 && _this$data6.selected ? 'selected' : '', this.nodeStyles(), (_this$data7 = this.data) === null || _this$data7 === void 0 ? void 0 : _this$data7.label, this.outputs().map(function (_ref) {
          ...
          var _ref2 = _slicedToArray(_ref, 2),
            key = _ref2[0],
            output = _ref2[1];
          return html(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n                        <div class=\"output\" data-testid=\"output-", "\">\n                            <div\n                                class=\"output-title\"\n                                data-testid=\"output-title\"\n                            >\n                                ", "\n                            </div>\n                            <ref-element\n                                class=\"output-socket\"\n                                .data=", "\n                                .emit=", "\n                                data-testid=\"output-socket\"\n                            ></ref-element>\n                        </div>\n                    "])), key, output.label, {
            type: 'socket',
            side: 'output',
            key: key,
          ...
          var _ref4 = _slicedToArray(_ref3, 2),
            key = _ref4[0],
            control = _ref4[1];
          return html(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n                        <ref-element\n                            data-testid=\"control-", "\"\n                            class=\"control\"\n                            .emit=", "\n                            .data=", "\n                        ></ref-element>\n                    "])), key, _this2.emit, {
            type: 'control',
            payload: control
          });
...
var Socket = _decorate$b([customElement('socket-component')], function (_initialize, _LitElement) {
...
_decorate$a([customElement('block-component')], function (_initialize, _LitElement) {
...
_decorate$9([customElement('item-component')], function (_initialize, _LitElement) {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return html(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n      <block-component class=\"block ", "\" data-testid=\"context-menu-item\">\n        <div \n          class=\"content\"\n          @click=\"", "\"\n          @wheel=\"", "\"\n          @pointerover=\"", "\"\n          @pointerleave=\"", "\"\n          @pointerdown=\"", "\"\n        >\n          <slot></slot>\n          ", "\n        </div>\n      </block-component>\n    "])), this.subitems ? 'hasSubitems' : '', function (event) {
          ...
          return event.stopPropagation();
        }, this.subitems && this.visibleSubitems ? html(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n            <div class=\"subitems\">\n              ", "\n            </div>\n          "])), this.subitems.map(function (item) {
      ...
      key: "styles",
      value: function value() {
        return [vars, css(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n\n    .block {\n      padding: 0;\n    }\n\n    .content {\n      padding: 4px;\n      background-color: var(--context-color);\n    }\n\n    .hasSubitems:after {\n      content: '\u25BA';\n      position: absolute;\n      opacity: 0.6;\n      right: 5px;\n      top: 5px;\n    }\n\n    .subitems {\n      position: absolute;\n      top: 0;\n      left: 100%;\n      width: var(--width);\n    }\n  "])))];
      }
    }]
  };
}, LitElement);
...
_decorate$8([customElement('search-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "styles",
      value: function value() {
        return css(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n    .search {\n      color: white;\n      padding: 1px 8px;\n      border: 1px solid white;\n      border-radius: 10px;\n      font-size: 16px;\n      font-family: serif;\n      width: 100%;\n      box-sizing: border-box;\n      background: transparent;\n    }\n  "])));
      }
    }, {
      kind: "method",
      key: "render",
...
var Menu = _decorate$7([customElement('menu-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        var _this2 = this;
        return html(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n        <div\n            class=\"menu\"\n            @mouseover=\"", "\"\n            @mouseleave=\"", "\"\n            data-testid=\"context-menu\"\n            rete-context-menu\n        >\n            ", "\n            ", "\n        </div>\n    "])), this.hide.cancel, this.hide.call, this.searchBar ? html(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n                      <block-component>\n                          <search-component\n                              .text=\"", "\"\n                              @change=\"", "\"\n                          ></search-component>\n                      </block-component>\n                  "])), this.filter, function (e) {
...
var Minimap = _decorate$4([customElement('minimap-component')], function (_initialize, _LitElement) {
...
var Pins = _decorate$3([customElement('pins-component')], function (_initialize, _LitElement) {
...
var Transformer = _decorate$2(null, function (_initialize, _LitElement) {
  var Transformer = /*#__PURE__*/function (_LitElement2) {
    _inherits(Transformer, _LitElement2);
    ...
    // eslint-disable-next-line
    return _createClass(Transformer);
  }(_LitElement);
  return {
    F: Transformer,
    d: [{
      ...
      key: "socket",
      value: function value() {
        return new ClassicPreset.Socket('socket');
      }
    }, {
      kind: "field",
      "static": true,
...
var TransformerNode = _decorate$1([customElement('transformer-node')], function (_initialize, _LitElement) {
  var TransformerNode = /*#__PURE__*/function (_LitElement2) {
    _inherits(TransformerNode, _LitElement2);
    var _super = _createSuper$2(TransformerNode);
    function TransformerNode() {
      var _this;
      _classCallCheck(this, TransformerNode);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _super.call.apply(_super, [this].concat(args));
    ...
    return _createClass(TransformerNode);
  }(_LitElement);
  return {
    F: TransformerNode,
    d: [{
      ...
      key: "styles",
      value: function value() {
        return [vars$1, css(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n            :host {\n                display: block;\n            }\n\n            .node {\n                display: flex;\n                flex-direction: column;\n                background: var(--node-color);\n                border: 2px solid #4e58bf;\n                border-radius: 10px;\n                cursor: pointer;\n                box-sizing: border-box;\n                width: var(--node-width);\n                height: auto;\n                padding-bottom: 6px;\n                position: relative;\n                user-select: none;\n            }\n\n            .inputs,\n            .outputs {\n                display: flex;\n                flex-direction: row;\n            }\n\n            .inputs .input-socket {\n                margin-top: calc(\n                    (var(--socket-size) / -2) - var(--socket-margin)\n                );\n            }\n\n            .outputs .output-socket {\n                margin-bottom: calc(\n                    (var(--socket-size) / -2) - var(--socket-margin)\n                );\n            }\n\n            .input {\n                display: flex;\n                flex-direction: column;\n            }\n\n            .output {\n                display: flex;\n                flex-direction: column-reverse;\n            }\n\n            /* You can add other CSS rules here as needed */\n        "])))];
      }
    }, {
      kind: "method",
      key: "render",
...
export { LitPlugin, index as Presets, RefElement as Ref, Transformer, TransformerNode };

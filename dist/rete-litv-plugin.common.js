...
var Connection = _decorate$d([decorators.customElement('connection-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "styles",
      value: function value() {
        return lit.css(_templateObject$f || (_templateObject$f = _taggedTemplateLiteral__default["default"](["\n    svg {\n      overflow: visible !important;\n      position: absolute;\n      pointer-events: none;\n      width: 9999px;\n      height: 9999px;\n    }\n    path {\n      fill: none;\n      stroke-width: 5px;\n      stroke: steelblue;\n      pointer-events: auto;\n    }\n  "])));
      }
    }, {
      kind: "method",
      key: "render",
...
var ConnectionWrapper = _decorate$c([decorators.customElement('connection-wrapper')], function (_initialize, _LitElement) {
    ...
    d: [{
      ...
      value: function render() {
        if (this.component) {
          ...
          return lit.html(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral__default["default"](["", ""])), dynamicComponent);
        }
...
var Node = _decorate$a([decorators.customElement('node-component')], function (_initialize, _LitElement) {
      ...
      value: function render() {
        ...
        return lit.html(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral__default["default"](["\n            <div\n                class=\"node ", "\"\n                style=", "\n                data-testid=\"node\"\n            >\n                <div class=\"title\" data-testid=\"title\">", "</div>\n\n                <!-- Outputs -->\n                ", "\n\n                <!-- Controls -->\n                ", "\n\n                <!-- Inputs -->\n                ", "\n            </div>\n        "])), (_this$data6 = this.data) !== null && _this$data6 !== void 0 && _this$data6.selected ? 'selected' : '', this.nodeStyles(), (_this$data7 = this.data) === null || _this$data7 === void 0 ? void 0 : _this$data7.label, this.outputs().map(function (_ref) {
          ...
          var _ref4 = _slicedToArray__default["default"](_ref3, 2),
            key = _ref4[0],
            control = _ref4[1];
          return lit.html(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral__default["default"](["\n                        <ref-element\n                            data-testid=\"control-", "\"\n                            class=\"control\"\n                            .emit=", "\n                            .data=", "\n                        ></ref-element>\n                    "])), key, _this2.emit, {
            type: 'control',
            payload: control
          });
...
var Socket = _decorate$9([decorators.customElement('socket-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        var _this$data;
        return lit.html(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral__default["default"](["\n            <div\n                class=\"socket\"\n                title=\"", "\"\n                @click=\"", "\"\n            ></div>\n        "])), (_this$data = this.data) === null || _this$data === void 0 ? void 0 : _this$data.name, this.handleClick);
      }
    }]
  };
}, lit.LitElement);
...
_decorate$8([decorators.customElement('block-component')], function (_initialize, _LitElement) {
...
_decorate$7([decorators.customElement('item-component')], function (_initialize, _LitElement) {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return lit.html(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral__default["default"](["\n      <block-component class=\"block ", "\" data-testid=\"context-menu-item\">\n        <div \n          class=\"content\"\n          @click=\"", "\"\n          @wheel=\"", "\"\n          @pointerover=\"", "\"\n          @pointerleave=\"", "\"\n          @pointerdown=\"", "\"\n        >\n          <slot></slot>\n          ", "\n        </div>\n      </block-component>\n    "])), this.subitems ? 'hasSubitems' : '', function (event) {
          ...
          return event.stopPropagation();
        }, this.subitems && this.visibleSubitems ? lit.html(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral__default["default"](["\n            <div class=\"subitems\">\n              ", "\n            </div>\n          "])), this.subitems.map(function (item) {
...
_decorate$6([decorators.customElement('search-component')], function (_initialize, _LitElement) {
...
var Menu = _decorate$5([decorators.customElement('menu-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        var _this2 = this;
        return lit.html(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral__default["default"](["\n        <div\n            class=\"menu\"\n            @mouseover=\"", "\"\n            @mouseleave=\"", "\"\n            data-testid=\"context-menu\"\n            rete-context-menu\n        >\n            ", "\n            ", "\n        </div>\n    "])), this.hide.cancel, this.hide.call, this.searchBar ? lit.html(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral__default["default"](["\n                      <block-component>\n                          <search-component\n                              .text=\"", "\"\n                              @change=\"", "\"\n                          ></search-component>\n                      </block-component>\n                  "])), this.filter, function (e) {
      ...
      key: "styles",
      value: function value() {
        return [vars, lit.css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral__default["default"](["\n\n    .menu {\n      padding: 10px;\n      width: var(--width);\n      margin-top: -20px;\n      margin-left: calc(var(--width) / -2);\n    }\n  "])))];
      }
    }]
  };
}, lit.LitElement);
...
var MiniViewport = _decorate$3(null, function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "render",
      value: function render() {
        return lit.html(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral__default["default"](["\n      <div\n        class=\"mini-viewport\"\n        @pointerdown=", "\n        style=", "\n        data-testid=\"minimap-viewport\"\n      ></div>\n    "])), this.drag.start, this.styles);
      }
    }, {
      kind: "field",
      "static": true,
      key: "styles",
      value: function value() {
        return lit.css(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral__default["default"](["\n    .mini-viewport {\n      position: absolute;\n      background: rgba(255, 251, 128, 0.32);\n      border: 1px solid #ffe52b;\n    }\n  "])));
      }
    }]
  };
}, lit.LitElement);
...
var Minimap = _decorate$2([decorators.customElement('minimap-component')], function (_initialize, _LitElement) {
...
var Pins = _decorate$1([decorators.customElement('pins-component')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      key: "styles",
      value: function value() {
        return lit.css(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral__default["default"](["\n    :host {\n      display: block;\n    }\n  "])));
      }
    }, {
      kind: "method",
      key: "render",

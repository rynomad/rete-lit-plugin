...
export declare type LitArea2D<T extends ClassicScheme> = RenderSignal<'node', {
    payload: T['Node'];
...
export declare type ExtractPayload<T extends ClassicScheme, K extends string> = Extract<LitArea2D<T>, {
    type: 'render';
    data: {
        type: K;
    };
